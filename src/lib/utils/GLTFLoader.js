...
class GLTFMaterialsPbrSpecularGlossinessExtension {
  ...
  createMaterial(materialParams) {
    ...
    material.emissiveIntensity =
      materialParams.emissiveIntensity === undefined ? 1.0 : materialParams.emissiveIntensity;
    ...
    for (let i = 0, il = primitives.length; i < il; i++) {
      ...
      if (cached) {
        ...
        if (primitive.extensions && primitive.extensions[EXTENSIONS.KHR_DRACO_MESH_COMPRESSION]) {
          ...
          geometryPromise = addPrimitiveAttributes(new BufferGeometry(), primitive, parser, i);
        }
...
function addPrimitiveAttributes(geometry, primitiveDef, parser, index) {
  ...
  return Promise.all(pending).then(function () {
    return primitiveDef.targets !== undefined && primitiveDef.targets !== null && index == 0
